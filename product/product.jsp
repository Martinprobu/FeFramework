...
// 		var lastColumnHtmlList = [{class:"icon-zoom-in", title:"商品详情", method:"detailList"}];
		var lastColumnHtmlList = [{class:"icon-zoom-in", title:"详情", method:"simpleDetail"}, {key:"isGround", class1:"icon-external-link", title1:"上架", method1:"upStock", class2:"icon-download-alt", title2:"下架", method2:"downStock"}];	//有key(根据此属性判断是否真假)代表,是根据此key,选择title1还是title2
		// 全局变量  ================================================================================================================================================================ End>>>>>>>>>>>>>
		//	=========================================================================================================================================================================================
			
			//返回 
			$("#backBut").click(function() {
				 var openUrl = "product.php";
