						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="table-header">
									...
									供应商 : <span style="font-weight:bold">${ requestPojo.vendorName }</span>  . 商品详情
								</div>
												...
												<div class="tab-content">
													...
													<div id="home" class="tab-pane in active">
															...
															<div class="form-group">
																...
																<label class="col-sm-3 control-label no-padding-right" for="form-field-1">${requestPojo.marketPrice}</label>
															</div>
															<div class="space-4"></div>
															<div class="form-group">
