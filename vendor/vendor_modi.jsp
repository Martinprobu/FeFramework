								...
								<div class="hr hr10 hr-dotted"></div>
									<div class="col-xs-12" id="addFormDiv"> 
										<form class="form-horizontal" role="form">
											<input value="${requestVendor.vendorId}" name="vendorId" mustneed="true" id="vendorId" type="hidden" />
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="form-field-1">商家名字</label> 
												<div class="col-sm-6">
													<input value="${requestVendor.vendorName}" name="vendorName" mustneed="true" id="vendorName" type="text" placeholder="请输入商家名字" class="col-xs-10 col-sm-8" /> <span style="color:red;">*</span>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input value="${requestVendor.linkName}" name="linkName" mustneed="true" id="linkName" type="text" placeholder="请输入联系法人" class="col-xs-10 col-sm-8" /> <span style="color:red;">*</span>
												</div>
											</div>
											<div class="space-4"></div>
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input value="${requestVendor.mobilephone}" validate="number" mustneed="true" name="mobilephone" id="mobilephone"  type="text"  placeholder="请输入手机" class="col-xs-10 col-sm-8"> <span style="color:red;">*</span>
												</div>
											</div>
											<div class="space-4"></div>
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input value="${requestVendor.telephone}" validate="number" name="telephone" id="telephone" type="text"  placeholder="请输入固话" class="col-xs-10 col-sm-8">  
												</div>
											</div>
											<div class="space-4"></div>
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input value="${requestVendor.address}" name="address" id="address"  type="text"  placeholder="请输入地址" class="col-xs-10 col-sm-8">
												</div>
											</div>
											<div class="space-4"></div>
...
// 			$("#resetFunButton").click();
			defaultPopNoButtonWin("成功", "修改供应商", sucessFunFun);
		}
